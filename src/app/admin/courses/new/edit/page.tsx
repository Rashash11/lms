...
// Custom components
import Header from '@/components/admin/course-editor/Header';
import AddMenuGrouped from '@/components/admin/course-editor/AddMenu';
import CurriculumBuilder from '@/components/admin/course-editor/CurriculumBuilder';
import CloneLinkDialog from '@/components/admin/course-editor/CloneLinkDialog';
import GenericUnitModal from '@/components/admin/course-editor/GenericUnitModal';

// Unit Editors
import TextUnitEditor from '@/components/admin/unit-editors/TextUnitEditor';
import VideoUnitEditor from '@/components/admin/unit-editors/VideoUnitEditor';
import AudioUnitEditor from '@/components/admin/unit-editors/AudioUnitEditor';
import DocumentUnitEditor from '@/components/admin/unit-editors/DocumentUnitEditor';
import IframeUnitEditor from '@/components/admin/unit-editors/IframeUnitEditor';
import ILTUnitEditor from '@/components/admin/unit-editors/ILTUnitEditor';
import TestUnitEditor from '@/components/admin/unit-editors/TestUnitEditor';
import SurveyUnitEditor from '@/components/admin/unit-editors/SurveyUnitEditor';
import AssignmentUnitEditor from '@/components/admin/unit-editors/AssignmentUnitEditor';
import ScormUnitEditor from '@/components/admin/unit-editors/ScormUnitEditor';
...
// Drawers
import CourseSettingsDrawer from '@/components/admin/course-editor/CourseSettingsDrawer';
import CourseEnrollmentDrawer from '@/components/admin/course-editor/CourseEnrollmentDrawer';

// New Components
import CourseOutlineSidebar from '@/components/admin/course-editor/CourseOutlineSidebar';
import CourseOptionsTab from '@/components/admin/course-editor/CourseOptionsTab';
import CourseUsersTab from '@/components/admin/course-editor/CourseUsersTab';
import UnitOptionsDrawer from '@/components/admin/course-editor/UnitOptionsDrawer';
...
function CourseEditorContent() {
    ...
    const handleDuplicate = async () => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                router.push(`/courses/edit?id=${cloned.id}`);
    ...
    const handleDeleteUnit = async (uId: string) => {
        ...
        try {
            const res = await fetch(`/api/courses/${courseId}/units/${uId}`, { method: 'DELETE' });
            if (res.ok) {
    ...
    return (
        <Box sx={{ display: 'flex', flexDirection: 'column', height: '100vh', overflow: 'hidden' }}>
            ...
            <Box sx={{
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                    {saveState === 'saving' && (
                        <Typography sx={{ fontSize: '0.75rem', color: '#cbd5e0', fontWeight: 600 }}>
                            Saving...
                        </Typography>
                    )}
                    {saveState === 'saved' && (
            ...
            <Box sx={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
                ...
                <Box sx={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
                    {!editingUnitId ? (
                        ...
                        <Box sx={{ flex: 1, overflowY: 'auto', p: 8, pt: 4, bgcolor: '#fff' }}>
