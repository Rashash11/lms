                    ...
                    <Table>
                        ...
                        <TableBody>
                            {conferences.map((conf) => (
                                <TableRow key={conf.id} sx={{ '&:hover': { bgcolor: 'rgba(141, 166, 166, 0.03)' } }}>
                                    <TableCell>
                                    ...
                                    <TableCell sx={{ color: 'hsl(var(--foreground))', fontSize: 13, fontWeight: 500 }}>
                                        {new Date(conf.scheduledAt).toLocaleString([], { dateStyle: 'medium', timeStyle: 'short' })}
                                    </TableCell>
                                    <TableCell sx={{ color: 'hsl(var(--muted-foreground))', fontSize: 13, fontWeight: 500 }}>{conf.duration} min</TableCell>
                                    <TableCell sx={{ color: 'hsl(var(--foreground))', fontSize: 13, fontWeight: 600 }}>{conf.participants} users</TableCell>
                                    <TableCell>
                                        <Chip
                                            label={conf.status}
                                            size="small"
