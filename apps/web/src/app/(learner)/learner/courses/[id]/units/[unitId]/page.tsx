...
function CoursePlayerContent() {
    ...
    const handleMarkComplete = async () => {
        ...
        try {
            const data = await apiFetch<{ percent: number }>(`/api/learner/progress/units/${unitId}/complete`, { method: 'POST' });
        ...
        <Box sx={{
            ...
            <Box sx={{
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                    ...
                    <Typography component="div" sx={{ fontSize: '0.8rem', color: '#718096', mx: 1, display: 'flex', alignItems: 'center', gap: 1 }}>
