...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
    ...
    const [flyoutKey, setFlyoutKey] = useState<null | 'Reports'>(null);
        ...
        <Box sx={{
            ...
            <List sx={{ flex: 1, pt: 0, px: 1.5 }}>
                {menuItems.filter(item => {
                    ...
                    const shouldShowReportsFlyout = item.text === 'Reports';
                    return (
            ...
            <Menu
                ...
                open={Boolean(flyoutAnchorEl) && flyoutKey === 'Reports'}
                onClose={() => {
                    setFlyoutAnchorEl(null);
                    setFlyoutKey(null);
                }}
            ...
            >
                <MenuItem
                    ...
                    sx={{ color: TEXT_COLOR, '&:hover': { bgcolor: HOVER_BG } }}
                >
                    Overview
                </MenuItem>
                <MenuItem
